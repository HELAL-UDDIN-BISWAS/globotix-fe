  ...
  return (
    <>
      <div className="w-full rounded-[10px] bg-white ">
        <div className={`bg-yellow-1 h-2.5 rounded-t-[10px]`}></div>
        <div
          className={`cursor-pointer p-4 rounded-b-[10px] bg-white hover:bg-gradient-to-b hover:from-[#FFF9EC] hover:to-white`}
        >
