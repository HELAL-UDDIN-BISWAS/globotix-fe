...
const CardGoodCondition = (props) => {
  const { item } = props;
  return (
    <>
      <div className="w-full rounded-[10px] bg-white ">
        <div className={`bg-green-1 h-2.5 rounded-t-[10px]`}></div>
        <div
          className={`cursor-pointer p-4 rounded-b-[10px] bg-white hover:bg-gradient-to-b hover:from-[#E6F7EA] hover:to-white`}
        >
          <div className="flex justify-between items-center">
            <label className="text-black-1 font-semibold">
              {item?.base_id} {/*| {item?.module_id}*/}
            </label>
...
export default CardGoodCondition;
