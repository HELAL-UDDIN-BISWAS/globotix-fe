...
while (i < 50) {
  Data.push({
    _id: i + 1,
    plan_id: "Plan ID",
    plan_name: "T3 Departure Hall L3 R01",
    building: "Building " + (i + 1),
    publish_version: "3853 (New CPE)",
    modified_date: "28 Jan 2022, 01:09",
    est_duration: "1h 10’ 30”",
    est_cleaning_area: "100 m2",
  });
...
const getAllCleaningPlan = (filter) => {
  let arr = [...Data];
  let arrFilter = [];
  let ifArr = [
    `(${strDuration(filter)})`,
